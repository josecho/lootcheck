...
describe('Wallet', () => {
    ...
    it('display the balance form props', () => {
    ...
    describe('when the user types into the wallet input', () => {
        ...
        describe('and user wants to make a deposit', () => {
            ...
            it('dispatche the deposit() it recieves from props with local balance', () => {
                expect(mockDeposit).toHaveBeenCalledWith(parseInt(userBalance,10));
            });
       
        });

        describe('and user wants to make a withdrawal', () => {
            
            beforeEach(() => wallet.find('.btn-withdraw').simulate('click'));    
            
            it('dispatche the withdraw() it recieves from props with local balance', () => {
